        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div className="relative">
              <div className="aspect-square rounded-xl overflow-hidden relative bg-gradient-to-br from-quadvis-blue/20 to-quadvis-orange/20 backdrop-blur-md p-10">
                <div className="grid grid-cols-2 gap-6 h-full">
                  {[
                    ...
                    <div key={index} className="flex flex-col items-center justify-center text-center p-4 bg-black/30 rounded-xl">
              ...
              <div className="absolute -bottom-8 -right-8 h-40 w-40 border-2 border-dashed border-quadvis-orange/30 rounded-xl -z-10"></div>
            </div>
          </div>
